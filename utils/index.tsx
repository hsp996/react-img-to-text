...
// 二值化
export function thresholdFilter(pixels: any,level: number){
    if (level === undefined){
        level = 0.5
    }
...
// 高斯模糊
export function blurARGB(pixels: any, canvas: any, radius: any) {
...
//反转像素的颜色
export function invertColors(pixels: any) {
...
//增加图像的明亮区域
export function dilate(pixels: any, canvas: any) {
    let currIdx = 0;
